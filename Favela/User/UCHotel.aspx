...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <table>
        <tbody>
            <tr>
                <td class="style1"></td>
                <td align="left" colspan="1" class="style2">
                    <h3>Novo hotel</h3>
                    <form>
                    ...
                    <tr id="idGridHotGrupo" visible="true" runat="server">
                        <td colspan="2" class="style6">
                            <asp:GridView ID="gvHotGrupo" runat="server" DataKeyNames="Id"
                                BoderColor="#4B4D4C" CellPadding="2" GridLines="None" PageSize="1000"
                                ...
                                <Columns>
                                    <asp:BoundField HeaderText="Nome do Hotel" DataField="Nome">
